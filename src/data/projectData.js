export const projectData={
		...
		p1:'Chatting website (includes texting and video calling) build using MERN stack, WEBRTC and hosted it on AWS',
		p2:'This website is build using MERN stack, WEBRTC, Socket.io and hosted it EC2 instance, using Nginx as a reverse proxy web server and some other services provided by #aws like Elastic Load Balancer, Auto Scaling, Cloud Front which all together give a seamless performance to the website.',
		image:1,
		link: 'https://www.chatapp-priyamvada-aws.com/'
	},
		prject3:{
		title:'Data Visualization',
		p1:'A webiste where user can upload there data and can get all basic Visualization',
		p2:'This website is build using Chart.js, an open source javascript library for preparing fast and responsive charts, MongoDB Atlas for storing data and most efficient framework - React.js',
		image:2,
		link: 'https://data-visualization-react.herokuapp.com/'
	},
		prject4:{
		...
		image:3,
		link: 'https://retailapplication.herokuapp.com/'
	},
		prject5:{
		...
		image:4,
		link: 'https://bookwithhfi-ng.herokuapp.com/'
	},
		prject6:{
		...
		image:5,
		link: 'https://priyamvada-05.github.io/FaceRecognition_via_face-api/'
	},
		prject7:{
		...
		image:6,
		link: 'https://priyamvada-05.github.io/facerecognitionweb_clarifai/'
	}
}